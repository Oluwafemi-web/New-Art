                                  ...
                                  <section className="aheto-timeline--mooseoom-modern">
                                    <div className="aheto-timeline__timeline">
                                      <div className="aheto-timeline__events-wrapper">
                                        <div
                                          className="aheto-timeline__events"
                                          style={{ width: "1760px" }}
                                        >
                                          <ol>
                                            <li>
                                          ...
                                          <div className="aheto-timeline__wrap">
                                            ...
                                            <div className="aheto-timeline__content">
                                              ...
                                              <p className="aheto-timeline__desc">
                                                The MooM Art Collections is
                                                founded by a group of artists
                                                and patrons prompted by the
                                                government's inadequate museum
                                                funding. By its first meeting it
                                                has 308 members and $700 in
                                                funds.
                                              </p>
                                        ...
                                        <li data-date={1994}>
                                          <div className="aheto-timeline__wrap">
                                            ...
                                            <div className="aheto-timeline__content">
                                              ...
                                              <p className="aheto-timeline__desc">
                                                An additional new entrance to
                                                the gallery was created at the
                                                rear of the building, leading
                                                down from the new first floor
                                                gallery into a newly-opened up
                                                section of the Museum Gardens,
                                                which has been developed into a
                                                public space.
                                              </p>
                                              <div className="aheto-timeline-slider__links">
                                                <a
                                          ...
                                          <div className="aheto-timeline__wrap">
                                            ...
                                            <div className="aheto-timeline__content">
                                              ...
                                              <p className="aheto-timeline__desc">
                                                ...
                                                investment of £8 million into
                                                the MooM. We are very grateful
                                                to all our funders who have made
                                                this project possible and start
                                                new period of art vision.
                                              </p>
                                              <div className="aheto-timeline-slider__links">
                                                <a
                                        ...
                                        <li data-date={1999}>
                                          <div className="aheto-timeline__wrap">
                                            ...
                                            <div className="aheto-timeline__content">
                                              ...
                                              <p className="aheto-timeline__desc">
                                                The gallery now has three
                                                exhibition spaces on the ground
                                                floor, capable of hosting major
                                                national and international
                                                exhibitions, and four on the
                                                first floor, two of which
                                          ...
                                          <div className="aheto-timeline__wrap">
                                            ...
                                            <div className="aheto-timeline__content">
                                              ...
                                              <p className="aheto-timeline__desc">
                                                ...
                                                fundraising appeal, and a pledge
                                                of £500,000 from the Art Fund,
                                                the Fitzwilliam Museum,
                                                Cambridge, successfully acquires
                                                the Macclesfield Psalter and
                                        ...
                                        <li data-date={2008}>
                                          <div className="aheto-timeline__wrap">
                                            ...
                                            <div className="aheto-timeline__content">
                                              ...
                                              <p className="aheto-timeline__desc">
                                                The Art Fund Prize awarded to
                                                the the MooM. The Art Fund gives
                                                £600,000 to Tate’s campaign to
                                                save Rubens’s Banqueting House
                                                sketch. The Art Fund gives an
                                                exceptional grant of £1 million
                                          ...
                                          <div className="aheto-timeline__wrap">
                                            ...
                                            <div className="aheto-timeline__content">
                                              ...
                                              <p className="aheto-timeline__desc">
                                                ...
                                                Etty and held the first major
                                                exhibition of his work for 50
                                                years, showing many of these
                                                paintings and sketches alongside
                                                loans from other major
                                                galleries.
                                              </p>
                                              <div className="aheto-timeline-slider__links">
                                                <a
                                          ...
                                          <div className="aheto-timeline__wrap">
                                            ...
                                            <div className="aheto-timeline__content">
                                              ...
                                              <p className="aheto-timeline__desc">
                                                ...
                                                continues through AAMC
                                                conference travel fellowship and
                            ...
                            >
                              <div className="elementor-widget-container">
                                <div className="aheto-cpt aheto-cpt--masonry-mooseoom js-popup-gallery aheto_custom-post-types_64a0a111c4590 ">
                                  ...
                                  >
                                    <div
                                      className="aheto-cpt-article aheto-cpt-article--size"
                                      style={{
                                        position: "absolute",
                                        left: "0%",
                                        top: "0px",
                              ...
                              <div className="elementor-widget-container">
                                <div className="aheto-heading aheto-heading--mooseoom__simple  aheto_heading_64a0a111c8a1b ">
                                  ...
                                  <p className="aheto-heading__title">
                                    The MooM exists to exhibit, interpret,
                                    preserve and promote the visual, artistic
                                    and cultural heritage of Indigenous Peoples;
                                    to educate and engage the public on local,
                                    regional and global social issues through
                                    the visual arts.present, collect and
                                    interpret historic and contemporary art in
                                    innovative and challenging ways that
                            ...
                            >
                              <div className="elementor-widget-container">
                                <div className="aheto-heading aheto-heading--mooseoom__simple  aheto_heading_64a0a111c9d5f ">
                                  ...
                                  <p className="aheto-heading__title">
                                    We envision a gallery accessible to everyone
                                    as a vibrant public space in service of our
                                    community, to foster greater social
                                    engagement, critical thinking and
                                    creativity. Inspiring and challenging our
                              ...
                              <div className="elementor-widget-container">
                                <div className="aheto-heading aheto-heading--mooseoom__simple  aheto_heading_64a0a111cc63c ">
                                  ...
                                  <p className="aheto-heading__title">
                                    ...
                                    quality programs and exhibitions. We provide
                                    a cultural and educational service of the
                                    very highest quality and to act as a focus
                                    for civic pride and community identity for
                                    the people. The gallery interacts with the
                                    community by designing programs that
                                    inspire, challenge, educate and entertain.
                                  </p>
                                </div>
                              </div>
                            </div>
